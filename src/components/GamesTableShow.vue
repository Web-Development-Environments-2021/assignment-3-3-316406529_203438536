  ...
  <div>
    ...
    >
      ...
      <template #cell(eventSchedule)="data">
        <b-button v-b-modal.gameEvents @click="CurEventData(data.value)"
          >Game Events List</b-button
        >
      </template>
      ...
      <template #cell(add_to_favorite)="data">
        <b-button v-if="addButton" @click="addGamesToFavorites(data.value)"
